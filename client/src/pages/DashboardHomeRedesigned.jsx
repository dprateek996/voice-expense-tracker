...
import { SkeletonStatCard, SkeletonBudgetBar, SkeletonExpenseRow } from '@/components/ui/SkeletonCard';
    ...
    <div className="container py-12">
      ...
      {loading ? (
        <>
          ...
          <section className="mt-8"><SkeletonBudgetBar /></section>
          <section className="mt-12">
            <h2 className="text-heading text-2xl font-semibold">Recent expenses</h2>
            <div className="mt-6 surface-2 overflow-hidden rounded-lg border border-border shadow-sm">
              {[...Array(5)].map((_, i) => <SkeletonExpenseRow key={i} />)}
            </div>
          </section>
        </>
      ) : (
